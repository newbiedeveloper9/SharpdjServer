...
{
    public class ServerDisconnectAction : AbstractHandler, IAction<DisconnectRequest>
    {
        ...
        public Task ProcessRequest(DisconnectRequest req, Connection conn, IList<IActionBag> actionBags)
        {
            throw new NotImplementedException();
        }
    }
